...
class RAGTracer:
    ...
    def log_generation(self, prompt: str, answer: str, tokens_used: int, latency_ms: float):
    ...
    def score_feedback(self, trace_id: str, score: float, comment: Optional[str] = None):
        ...
        self.client.score(trace_id=trace_id, name="user_feedback", value=score, comment=comment)
